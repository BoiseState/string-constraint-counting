...
public class Alphabet {
	...
	public Alphabet(String symbolString) {
		...
		Set<Character> processedSymbolSet = getSymbolsFromDeclaration(symbolString);
	...
	private static Set<Character> getSymbolsFromDeclaration(String string) {
		...
		for (String symbolDeclaration : symbolDeclarations) {
			...
			else if (symbolDeclaration.length() == 3 && symbolDeclaration.charAt(1) == '-') {
	...
	private static void addRangeToSymbolSet(Set<Character> symbolSet, char start, char end) {
