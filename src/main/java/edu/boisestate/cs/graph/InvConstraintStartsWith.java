 ...
 */
public class InvConstraintStartsWith<T extends A_Model_Inverse<T>> extends A_Inv_Constraint<T> {
    ...
    public InvConstraintStartsWith(int ID, Solver_Inverse<T> solver) {
    ...
    public InvConstraintStartsWith(int ID, Solver_Inverse<T> solver, boolean result) {
        this(ID, solver);
        this.result = result;
    }

    public InvConstraintStartsWith(int ID, Solver_Inverse<T> solver, int argID) {
    ...
    public InvConstraintStartsWith(int ID, Solver_Inverse<T> solver, List<Integer> args) {
    ...
    public InvConstraintStartsWith(int ID, Solver_Inverse<T> solver, List<Integer> args, int base, int input) {
