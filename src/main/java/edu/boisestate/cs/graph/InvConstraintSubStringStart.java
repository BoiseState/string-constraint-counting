 ...
 *
 */
public class InvConstraintSubStringStart extends A_Inv_Constraint {


	private int start,end;

	public InvConstraintSubStringStart (int ID, Solver_Inverse solver, List<Integer> args) {
	...
	public InvConstraintSubStringStart (int ID, Solver_Inverse solver, List<Integer> args, int base, int input) {
	...
	public boolean evaluate(I_Inv_Constraint inputConstraint, int sourceIndex) {
		...
		Model_Acyclic_Inverse resModel = solver.inv_substring(inputModel, start);
