 ...
 *
 */
public class InvConstraintToUpperCase extends A_Inv_Constraint {
	
	
	public InvConstraintToUpperCase (int ID, Solver_Inverse solver) {
	...
	public InvConstraintToUpperCase (int ID, Solver_Inverse solver, List<Integer> args) {
	...
	public InvConstraintToUpperCase (int ID, Solver_Inverse solver, List<Integer> args, int base, int input) {
	...
	public boolean evaluate(I_Inv_Constraint inputConstraint, int sourceIndex) {
		...
		Model_Acyclic_Inverse resModel = solver.inv_toUpperCase(inputModel);
...
//			System.out.println("TOUPPER INCOMING SET INCONSISTENT...");
			...
			// perform inverse function on output from the input constraint at given index
			Model_Acyclic_Inverse resModel = solver.inv_toUpperCase(inputs);
