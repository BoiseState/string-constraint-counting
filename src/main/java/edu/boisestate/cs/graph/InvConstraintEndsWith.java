 ...
 */
public class InvConstraintEndsWith<T extends A_Model_Inverse<T>> extends A_Inv_Constraint<T> {
    ...
    public InvConstraintEndsWith(int ID, Solver_Inverse<T> solver) {
    ...
    public InvConstraintEndsWith(int ID, Solver_Inverse<T> solver, boolean result) {
        this(ID, solver);
        this.result = result;
    }

    public InvConstraintEndsWith(int ID, Solver_Inverse<T> solver, int argID) {
    ...
    public InvConstraintEndsWith(int ID, Solver_Inverse<T> solver, List<Integer> args) {
    ...
    public InvConstraintEndsWith(int ID, Solver_Inverse<T> solver, List<Integer> args, int base, int input) {
