 ...
 */
public class InvConstraintIsEmpty<T extends A_Model_Inverse<T>> extends A_Inv_Constraint<T> {
    ...
    public InvConstraintIsEmpty(int ID, Solver_Inverse<T> solver) {
    ...
    public InvConstraintIsEmpty(int ID, Solver_Inverse<T> solver, boolean result) {
        this(ID, solver);
        this.result = result;
    }

    public InvConstraintIsEmpty(int ID, Solver_Inverse<T> solver, int argID) {
    ...
    public InvConstraintIsEmpty(int ID, Solver_Inverse<T> solver, List<Integer> args) {
    ...
    public InvConstraintIsEmpty(int ID, Solver_Inverse<T> solver, List<Integer> args, int base, int input) {
