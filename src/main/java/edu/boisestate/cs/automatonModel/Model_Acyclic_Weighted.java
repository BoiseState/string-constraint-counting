...
public class Model_Acyclic_Weighted extends A_Model<Model_Acyclic_Weighted>{

	private AcyclicWeightedAutomaton automaton;

	protected Model_Acyclic_Weighted(AcyclicWeightedAutomaton automaton, 
	...
	@Override
	public Model_Acyclic_Weighted assertContainedInOther(Model_Acyclic_Weighted containingModel) {
		...
		ret.normalize();
		ret.minimize();
		return new Model_Acyclic_Weighted(ret, alphabet, boundLength);
	}



	@Override
	public Model_Acyclic_Weighted assertContainsOther(Model_Acyclic_Weighted containedModel) {
	...
	@Override
	public Model_Acyclic_Weighted assertEmpty() {
		...
		return new Model_Acyclic_Weighted(ret, alphabet, 0);
	}

	@Override
	public Model_Acyclic_Weighted assertEndsOther(Model_Acyclic_Weighted baseModel) {
		// TODO Auto-generated method stub
		return null;
	}

	@Override
	public Model_Acyclic_Weighted assertEndsWith(Model_Acyclic_Weighted endingModel) {
		// TODO Auto-generated method stub
		return null;
	}

	@Override
	public Model_Acyclic_Weighted assertEquals(Model_Acyclic_Weighted equalModel) {
	...
	@Override
	public Model_Acyclic_Weighted assertEqualsIgnoreCase(Model_Acyclic_Weighted equalModel) {
		// TODO Auto-generated method stub
		return null;
	}

	@Override
	public Model_Acyclic_Weighted assertHasLength(int min, int max) {
		// TODO Auto-generated method stub
		return null;
	}

	@Override
	public Model_Acyclic_Weighted assertNotContainsOther(Model_Acyclic_Weighted notContainingModel) {
	...
	@Override
	public Model_Acyclic_Weighted assertNotContainedInOther(Model_Acyclic_Weighted notContainedModel) {
	...
	@Override
	public Model_Acyclic_Weighted assertNotEmpty() {
...
//		AcyclicWeightedAutomaton ret = this.automaton.minus(arg);
	...
	@Override
	public Model_Acyclic_Weighted assertNotEndsOther(Model_Acyclic_Weighted notEndingModel) {
		// TODO Auto-generated method stub
		return null;
	}

	@Override
	public Model_Acyclic_Weighted assertNotEndsWith(Model_Acyclic_Weighted notEndingModel) {

		return null;
	}

	@Override
	public Model_Acyclic_Weighted assertNotEquals(Model_Acyclic_Weighted notEqualModel) {
	...
	@Override
	public Model_Acyclic_Weighted assertNotEqualsIgnoreCase(Model_Acyclic_Weighted notEqualModel) {
		// TODO Auto-generated method stub
		return null;
	}

	@Override
	public Model_Acyclic_Weighted assertNotStartsOther(Model_Acyclic_Weighted notStartingModel) {
		// TODO Auto-generated method stub
		return null;
	}

	@Override
	public Model_Acyclic_Weighted assertNotStartsWith(Model_Acyclic_Weighted notStartsModel) {
		// TODO Auto-generated method stub
		return null;
	}

	@Override
	public Model_Acyclic_Weighted assertStartsOther(Model_Acyclic_Weighted startingModel) {
		// TODO Auto-generated method stub
		return null;
	}

	@Override
	public Model_Acyclic_Weighted assertStartsWith(Model_Acyclic_Weighted startingModel) {
		// TODO Auto-generated method stub
		return null;
	}

	@Override
	public Model_Acyclic_Weighted concatenate(Model_Acyclic_Weighted arg) {
...
//		System.out.println("Concat2 " + res.getStringCount());
		//System.exit(2);
		return new Model_Acyclic_Weighted(res, this.alphabet);
	}
	...
	@Override
	public Model_Acyclic_Weighted delete(int start, int end) {
		/*
...
//			}
	...
	@Override
	public boolean equals(Model_Acyclic_Weighted arg) {
		// TODO Auto-generated method stub
		return false;
	}

	@Override
	public Model_Acyclic_Weighted intersect(Model_Acyclic_Weighted arg) {
		AcyclicWeightedAutomaton res = this.automaton.intersection(arg.automaton);
		return new Model_Acyclic_Weighted(res, alphabet);
	}
	...
	@Override
	public Model_Acyclic_Weighted replace(char find, char replace) {
	...
	@Override
	public Model_Acyclic_Weighted replace(String find, String replace) {
		// TODO Auto-generated method stub
		return null;
	}

	@Override
	public Model_Acyclic_Weighted replaceChar() {
		// TODO Auto-generated method stub
		return null;
	}

	@Override
	public Model_Acyclic_Weighted replaceFindKnown(char find) {
		// TODO Auto-generated method stub
		return null;
	}

	@Override
	public Model_Acyclic_Weighted replaceReplaceKnown(char replace) {
		// TODO Auto-generated method stub
		return null;
	}

	@Override
	public Model_Acyclic_Weighted reverse() {
		// TODO Auto-generated method stub
		return null;
	}

	@Override
	public Model_Acyclic_Weighted substring(int start, int end) {
		//		if(start == 0 && end == 0){
	...
	@Override
	public Model_Acyclic_Weighted setCharAt(int offset, Model_Acyclic_Weighted argModel) {
		// TODO Auto-generated method stub
		return null;
	}

	@Override
	public Model_Acyclic_Weighted setLength(int length) {
		// TODO Auto-generated method stub
		return null;
	}

	@Override
	public Model_Acyclic_Weighted suffix(int start) {
		// TODO Auto-generated method stub
		return null;
	}

	@Override
	public Model_Acyclic_Weighted toLowercase() {
		AcyclicWeightedAutomaton res = automaton.clone();
		for(WeightedState s : res.getStates()){
			Set<WeightedTransition> transSet = new HashSet<WeightedTransition>();
			transSet.addAll(s.getTransitions());
	...
	@Override
	public Model_Acyclic_Weighted toUppercase() {
		// TODO Auto-generated method stub
		return null;
	}

	@Override
	public Model_Acyclic_Weighted trim() {
		// TODO Auto-generated method stub
		return null;
	}

	@Override
	public Model_Acyclic_Weighted clone() {
		AcyclicWeightedAutomaton res = automaton.clone();
		return new Model_Acyclic_Weighted(res, alphabet);
	}
